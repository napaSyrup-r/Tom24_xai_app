...
📺 Video Demonstration
Note to Reviewers: Click the badge above to watch a walk-through of the application, demonstrating real-time crop disease diagnosis, convolutional layer activation maps (Grad-CAM), and superpixel feature perturbations (LIME).
